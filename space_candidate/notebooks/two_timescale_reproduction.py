...
def _(mo):
    ...
    All scientific compute ran on Hugging Face `cpu-upgrade`; no GPU device was detected. Full raw JSON, source hashes, assumptions, controls, seeds, and limitations live in [current report](../reports/current/report.md).
    """)
    return
