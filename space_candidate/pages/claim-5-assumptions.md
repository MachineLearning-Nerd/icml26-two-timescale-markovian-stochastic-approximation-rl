...
**Current verdict: pending the hash-pinned verifier run.**
...
Limitation: this verifies the exact dependency statement, not that every external problem instance satisfies the premises. Raw output, actual allocation, runtime, Git SHA, and checker output will be placed inline after the preregistered run.
